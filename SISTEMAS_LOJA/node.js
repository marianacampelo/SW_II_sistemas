...
function atualizarCarrinho() {
    ...
    for (const id in carrinhoProdutos) {
        ...
        <div class="item-carrinho-info">
            ...
            <div class="quantidade-container">
                <button class="btn-quatidade" data-id="${id}" data-acao="diminuir">-</button>
    ...
    contadorQuantidade.style.display = quantidadeTotal > 0 ? 'incline-block' : 'none';
